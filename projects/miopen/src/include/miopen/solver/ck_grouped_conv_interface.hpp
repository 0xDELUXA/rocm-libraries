...
int ckgrpconv_get_api_version();

// -- Kernel list accessors --------------------------------------------------

/// Number of kernel IDs in the list.
size_t ckgrpconv_kernel_list_size(const CKKernelListHandle* handle);
...
void ckgrpconv_solution_free(miopen::solver::ConvSolution* solution);
