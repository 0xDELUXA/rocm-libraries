...
/**
 * @struct amdgcn_mma
 * @brief Specialization of amdgcn_wmma for bf16_t, bf16_t, fp32_t MMA operation on GFX12
 * architecture.
 * @tparam CtrlFlags Control flags for the WMMA operation
 * @tparam CompilerTarget Current compiler target
 */
...
/**
 * @struct amdgcn_mma
 * @brief Specialization of amdgcn_wmma for fp16_t, fp16_t, fp16_t MMA operation on GFX12
 * architecture.
 * @tparam CtrlFlags Control flags for the WMMA operation
 * @tparam CompilerTarget Current compiler target
 */
...
/**
 * @struct amdgcn_mma
 * @brief Specialization of amdgcn_wmma for bf16_t, bf16_t, bf16_t MMA operation on GFX12
 * architecture.
 * @tparam CtrlFlags Control flags for the WMMA operation
 * @tparam CompilerTarget Current compiler target
 */
...
/**
 * @struct amdgcn_mma
 * @brief Specialization of amdgcn_wmma for uint8_t, uint8_t, int32_t MMA operation on GFX12
 * architecture.
 * @tparam CtrlFlags Control flags for the WMMA operation
 * @tparam CompilerTarget Current compiler target
 */
...
/**
 * @struct amdgcn_mma
 * @brief Specialization of amdgcn_wmma for fp8_t, fp8_t, fp32_t MMA operation on GFX12
 * architecture.
 * @tparam CtrlFlags Control flags for the WMMA operation
 * @tparam CompilerTarget Current compiler target
 */
...
/**
 * @struct amdgcn_mma
 * @brief Specialization of amdgcn_wmma for fp8_t, bf8_t, fp32_t MMA operation on GFX12
 * architecture.
 * @tparam CtrlFlags Control flags for the WMMA operation
 * @tparam CompilerTarget Current compiler target
 */
...
/**
 * @struct amdgcn_mma
 * @brief Specialization of amdgcn_wmma for bf8_t, fp8_t, fp32_t MMA operation on GFX12
 * architecture.
 * @tparam CtrlFlags Control flags for the WMMA operation
 * @tparam CompilerTarget Current compiler target
 */
...
/**
 * @struct amdgcn_mma
 * @brief Specialization of amdgcn_wmma for bf8_t, bf8_t, fp32_t MMA operation on GFX12
 * architecture.
 * @tparam CtrlFlags Control flags for the WMMA operation
 * @tparam CompilerTarget Current compiler target
 */
